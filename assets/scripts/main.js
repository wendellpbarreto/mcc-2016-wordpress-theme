...
$(document).ready(function() {
    $('.hero__down-button-link').addClass("animated").addClass("bounce").addClass("appeared");
});
...
new cbpScroller(document.getElementById('blog'));
new cbpScroller(document.getElementById('book'));
new cbpScroller(document.getElementById('academic'));
new cbpScroller(document.getElementById('footer'));


var scrollHandler = function() {
    var scrollTop = $(window).scrollTop();
    var heroHeight = $('#hero').outerHeight() - 86;

    if (scrollTop > heroHeight) {
        classie.remove(document.getElementById('header'), 'fadeOutUp');
        classie.add(document.getElementById('header'), 'appeared');
        classie.add(document.getElementById('header'), 'show');
        classie.add(document.getElementById('header'), 'fadeInDown');
    } else if (scrollTop < heroHeight) {
        classie.add(document.getElementById('header'), 'fadeOutUp');
        classie.remove(document.getElementById('header'), 'fadeInDown');
    }
};
